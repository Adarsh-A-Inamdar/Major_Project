...
\author[1]{Anmol Kundap}
\author[1]{Adarsh A Inamdar}
\author[1]{Tanushree M Pujar}
\author[1]{Amogh K Baliga}
\author[1]{Dr. Pradeep N}

\affil[1]{Department of Computer Science and Engineering, Bapuji Institute of Engineering and Technology, Davangere, Karnataka, India\protect\\
\texttt{\{anmolkundap2004, eradarshainamdar, tanushreempujar, amoghbaliga254257, nmnpradeep\}@gmail.com}}
...
\textbf{Keywords:} Leukemia Classification, Deep Learning, Particle Swarm Optimization, ResNet-18, Medical Image Analysis, Computer-Aided Diagnosis, Convolutional Neural Networks.
...
\begin{figure}[H]
    ...
    \caption{Detailed Methodology Flowchart}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{multitask_confusion_matrix.png}
    \caption{Confusion Matrix for Leukemia Subtypes}
